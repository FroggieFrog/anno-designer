...
namespace FandomTemplateExporter
{
    /// <summary>
    ...
    public partial class App : Application
    {
        ...
        {
            if (FandomTemplateExporter.Properties.Settings.Default.SettingsUpgradeNeeded)
            {
                logger.Trace("upgrade settings");

                FandomTemplateExporter.Properties.Settings.Default.Upgrade();
                FandomTemplateExporter.Properties.Settings.Default.SettingsUpgradeNeeded = false;
                FandomTemplateExporter.Properties.Settings.Default.Save();
            }
